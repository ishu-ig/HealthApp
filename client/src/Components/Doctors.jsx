            ...
            {title ?
                <div className="position-relative">
                    <div
                        ...
                        style={{
                            background: 'url("/assets/img/doctor-banner.jpg") center/cover no-repeat',
                            position: 'relative',
                            zIndex: 1,
                        }}
                    >
            ...
            <div className="container-fluid py-5 bg-white wow fadeInUp" data-wow-delay="0.2s">
                <div className="container">
                    {/* {title && (
                        <div className="section-title mb-5 text-center">
                            ...
                            <p className="text-muted mx-auto" style={{ maxWidth: '600px' }}>
                                Select from a wide range of expert doctors across multiple specializations for your care.
                            </p>
                        </div>
                    )} */}
                        ...
                        {data.map((item) => (
                            <div className="col-12 col-sm-6 col-lg-4 text-center" key={item._id}>
                                ...
                                >
                                    ...
                                    <p className="text-muted mb-1"><strong>Specialization:</strong> {item.specialization?.name || "N/A"}</p>
                                    ...
                                    <Link to={`/doctors/${item._id}`} className="btn btn-sm btn-outline-primary">Book Appointment</Link>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="text-center mt-5">
                        <Link to="/doctors" className="btn btn-primary px-4 py-2">
                            View More Doctors
                        </Link>
                    </div>
                </div>
