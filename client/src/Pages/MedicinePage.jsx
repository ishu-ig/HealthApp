            ...
            <div className="container-fluid py-5 wow fadeInUp bg-light" data-wow-delay="0.1s">
                <div className="container">
                    <div className="section-title mb-5 text-center">
                        <h5 className="position-relative d-inline-block text-primary text-uppercase">Our Medicine Store</h5>
                        <h1 className="display-6 fw-bold mb-4">Explore Medicines by Category</h1>
                    ...
                    <div className="row g-4">
                        {
                            MedicineCategoryStateData?.map((item, index) => (
                                <div className="col-12 col-sm-6 col-lg-4" key={index}>
                                    <Link to={`/medicine/shop?mc=${item.name}`}>
                                        <div
