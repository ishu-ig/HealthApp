...
const styles = `
  ...
  .abs-card-icon.green { background: #e6f5ed; }
...
export default function AdminDoctorAppointmentShow() {
  const { _id } = useParams();
  ...
  useEffect(() => {
    ...
    if (DoctorAppointmentStateData.length) {
      const item = DoctorAppointmentStateData.find((x) => x._id === _id);
      if (item) {
        setData({ ...item });
    ...
    <>
      ...
      <div className="abs-wrap">
        ...
        <div className="abs-header" style={{ maxWidth: 1100, margin: "0 auto 2rem" }}>
          <h1 className="abs-page-title">Doctor Appointment Details</h1>
          <Link to="/admin/doctorAppointment" className="abs-back-btn">
        ...
        <div className="abs-grid">
          ...
          <div>
            ...
            <div className="abs-card">
              ...
              <div className="abs-rows">
                ...
                <div className="abs-row">
                  <span className="abs-row-label">Doctor</span>
                ...
                <div className="abs-row">
                  ...
                  <span className="abs-row-value">{data.serviceType || "Consultation"}</span>
                </div>
                <div className="abs-row">
                  <span className="abs-row-label">Appointment Mode</span>
                  <span className="abs-row-value">{data.appointmentMode || "—"}</span>
                </div>
                <div className="abs-row">
          ...
          <div>
            ...
            <div className="abs-summary-card">
              <p className="abs-summary-label">Doctor</p>
              <p className="abs-summary-name">{data.doctor?.name || "—"}</p>
              ...
              <div className="abs-stat-row">
                <span className="abs-stat-label">Mode</span>
                <span className="abs-stat-val">{data.appointmentMode || "—"}</span>
              </div>
              <div className="abs-stat-row">
                <span className="abs-stat-label">Service</span>
                <span className="abs-stat-val">{data.serviceType || "Consultation"}</span>
              </div>
              <div className="abs-stat-row">
