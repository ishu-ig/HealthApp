...
import { createLabtestCategory, getLabtestCategory } from '../../Redux/ActionCreators/LabtestCategoryActionCreators'

export default function AdminCreateLabtestCategory() {
    ...
    function postSubmit(e) {
        ...
        if (errorItem)
            ...
            let item = LabtestCategoryStateData.find(x => x.name.toLocaleLowerCase() === data.name.toLocaleLowerCase())
            console.log(item)
            if (item) {
                setShow(true)
                setError((old) => {
                ...
                // dispatch(createLabtestCategory({ ...data }))
                ...
                dispatch(createLabtestCategory(formData))
    ...
    return (
        <>
            <div className="container">
                <h5 className="text-center text-light bg-primary p-2">Create LabtestCategory <Link to="/LabtestCategory"><i className="fa fa-arrow-left text-light float-end pt-1"></i></Link></h5>
                {/* Form */}
