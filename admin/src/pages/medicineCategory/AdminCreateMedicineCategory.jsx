...
import { createMedicineCategory, getMedicineCategory } from '../../Redux/ActionCreators/MedicineCategoryActionCreators'

export default function AdminCreateMedicineCategory() {
    ...
    function postSubmit(e) {
        ...
        if (errorItem)
            ...
            let item = MedicineCategoryStateData.find(x => x.name.toLocaleLowerCase() === data.name.toLocaleLowerCase())
            console.log(item)
            if (item) {
                setShow(true)
                setError((old) => {
                ...
                // dispatch(createMedicineCategory({ ...data }))
                ...
                dispatch(createMedicineCategory(formData))
    ...
    return (
        <>
            <div className="container">
                <h5 className="text-center text-light bg-primary p-2">Create MedicineCategory <Link to="/MedicineCategory"><i className="fa fa-arrow-left text-light float-end pt-1"></i></Link></h5>
                {/* Form */}
